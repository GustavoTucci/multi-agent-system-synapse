...
from ..tools.tool_agent_cartao import get_limit_utilization, get_min_payment_rate, get_balance_trend
...
agent_cartao = LlmAgent(
    ...
    instruction="""
        ...
        Sua missão é gerar um relatório estruturado no formato do output_schema para o Agente Orquestrador.
    ...
    output_schema=RespostaCartaoAgente
)
